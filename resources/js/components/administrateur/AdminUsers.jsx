          ...
          <table className="w-full text-left">
            <thead>
              <tr className="border-b border-gray-700">
                <th className="pb-3 text-gray-400 font-medium">Utilisateur</th>
                <th className="pb-3 text-gray-400 font-medium">Prenom</th>
                <th className="pb-3 text-gray-400 font-medium">Numéro de téléphone</th>
                <th className="pb-3 text-gray-400 font-medium">statuts</th>
            ...
            <tbody>
              {events.map(event => (
                <tr key={event.id} className="border-b border-gray-800">
                  <td className="py-4">
                    <div className="font-medium text-white">{event.nom}</div>
                  </td>
                  <td className="py-4 text-gray-300">{event.prenom}</td>
                  <td className="py-4 text-gray-300">{event.telephone}</td>
                  <td className="py-4">
                    <span className={`px-2 py-1 rounded-full text-xs font-medium ${getStatusColor(event.statut)}`}>
                      {event.statut === 'active' ? 'Actif' : event.statut === 'draft' ? 'Brouillon' : 'Annulé'}
                    </span>
                  </td>
                  <td className="py-4 text-gray-300">
                    {event.ticketsSold}/{event.statut}
                  </td>
                  <td className="py-4">
